use bevy::prelude::*;
use bevy::window::{Cursor, PresentMode, WindowLevel, WindowResolution};
use bevy::window::WindowMode;

/// This example demonstrates how to show fullscreen window among multiple screens.
/// example window resolution: 3840x1080
